<header class="main-header">
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"> <img src="{{ url('/assets/img/greefi.jpg') }}" height="25px"> {{ auth()->user()->transport_name }}</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{ auth()->user()->transport_name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ url('/assets/img/avatar5.png') }}" class="img-circle" alt="User Image">
                            <p>
                                {{ auth()->user()->transport_name }}
